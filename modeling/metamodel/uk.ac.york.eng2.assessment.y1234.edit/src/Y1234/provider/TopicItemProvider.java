...
/**
 * This is the item provider adapter for a {@link Y1234.Topic} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TopicItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Y1234Package.Literals.TOPIC__NAME,
				 true,
				 false,
				 false,
	...
	protected void addPublishersPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Topic_publishers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Topic_publishers_feature", "_UI_Topic_type"),
				 Y1234Package.Literals.TOPIC__PUBLISHERS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Y1234Package.Literals.TOPIC__SUBSCRIBERS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Y1234Package.Literals.TOPIC__EVENT);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Topic.class)) {
			case Y1234Package.TOPIC__NAME:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case Y1234Package.TOPIC__EVENT:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(Y1234Package.Literals.TOPIC__EVENT,
